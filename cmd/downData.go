...
// downDataCmd represents the downData command
var downDataCmd = &cobra.Command{
	Use:   "downData",
...
func init() {
	RootCmd.AddCommand(downDataCmd)

	// Here you will define your flags and configuration settings.

	// Cobra supports Persistent Flags which will work for this command
	// and all subcommands, e.g.:
	// downDataCmd.PersistentFlags().String("foo", "", "A help for foo")
